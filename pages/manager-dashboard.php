...
<head>
  ...
  <title>Manager Dashboard | POS Accounting System</title>
...
<body class="dashboard-body">
  ...
  <div class="d-flex">
    ...
    <aside class="sidebar d-flex flex-column p-3">
      ...
      <span class="role-tag align-self-start mb-3">Manager<!-- @M3: echo $_SESSION['role'] here --></span>
    ...
    <main class="main-content">
      <nav class="navbar navbar-custom px-4 py-3">
        <h1 class="h5 mb-0 fw-bold">Manager Dashboard</h1>
        <span class="text-muted small">Logged in as <strong>Manager<!-- @M3: echo $_SESSION['full_name'] here --></strong></span>
      </nav>
      ...
      <div class="p-4">
        <div class="row g-3 mb-4">
          ...
          <div class="col-md-3">
            <div class="card stat-card">
              <div class="card-body d-flex align-items-center gap-3">
                <div class="icon bg-secondary-subtle"><i class="bi bi-person-badge"></i></div>
                <div><div class="text-muted small">Employees</div><div class="h5 mb-0">0</div></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-4">
            <div class="card">
              ...
              <div class="card-body d-grid gap-2">
                ...
                <button class="btn btn-outline-primary btn-sm text-start" disabled>Run Payroll</button>
                <button class="btn btn-outline-primary btn-sm text-start" disabled>View Reports</button>
              </div>
            </div>
          </div>
        </div>
